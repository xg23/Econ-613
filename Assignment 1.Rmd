...
pgm
```
Note that there are NAs in choicepgm, so the number of programs is: 33 - 1 = 32
...
# cutoff <- cutoff %>%  gather(variable, value, -(rankplace:quantile)) %>% 
#           unite(temp, rankplace, variable) %>% spread(temp, value)
