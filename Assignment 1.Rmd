...
ss <- sss %>% 
  ...
  distinct(schoolcode, .keep_all = T) # Note that some school names do not match their school code,
# we will only use school codes as id variable. 
...
## Excercise 2
The school level dataset is presented by 'stu5'
```{r}
df <- stu1 %>%
